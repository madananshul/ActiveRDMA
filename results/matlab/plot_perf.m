...
barweb(1e-9*times, 1.96e-9*stddev, [], {'AB', 'Stream-Read (5MB)', 'Stream-Write (5MB)'}, 'Wall-clock Performance', 'FS', 'Runtime (s)', [], [], {'NFS', 'ARFS-rdma', 'ARFS-active'}, [], [])

print('-dpdf', 'wallclock.pdf')