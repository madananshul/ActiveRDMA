...
#define java_lang_Thread_MAX_PRIORITY 10L
  ...
  jlong threadId;
  struct Hjava_lang_Object* parkBlocker;
  struct Hgnu_java_util_WeakIdentityHashMap* locals;
  struct Hjava_lang_Thread_UncaughtExceptionHandler* exceptionHandler;
} Hjava_lang_Thread;
