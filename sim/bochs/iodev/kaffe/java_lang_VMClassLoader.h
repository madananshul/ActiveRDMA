...
extern struct Hjava_lang_Class* java_lang_VMClassLoader_getPrimitiveClass(jchar);
extern struct Hjava_lang_Class* java_lang_VMClassLoader_findLoadedClass(struct Hjava_lang_ClassLoader*, struct Hjava_lang_String*);
